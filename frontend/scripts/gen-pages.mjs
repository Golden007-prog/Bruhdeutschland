...
const PAGES = [
  ...
  { path: "/career/job-search", file: "career/JobSearch", comp: "CareerJobSearch", label: "German job-search toolkit", title: "Finding & applying for a German job", eyebrow: "§ Job search", desc: "Where to search, a German CV vs Europass and Anschreiben scaffold, Arbeitszeugnis literacy, and how a Werkstudent role converts to a permanent, visa-sponsoring job.", group: "career", icon: "Search" },
  ...
  { path: "/language/test-centers", file: "language/TestCenters", comp: "LanguageTestCenters", label: "Test centres & booking", title: "Test centres & booking-date reminders", eyebrow: "Übungstests · Booking", desc: "Official registration links per admission test plus a personal booking-date reminder you can export to your calendar.", group: "language", category: "language", icon: "CalendarClock" },
  ...
  { path: "/language/exams/testas", file: "language/exams/Testas", comp: "ExamTestas", label: "TestAS mock", title: "TestAS — Core module practice", eyebrow: "Übungstest · TestAS", desc: "A timed, auto-scored practice run of the TestAS Core module (Kerntest): quantitative problems, relationship reasoning, and number/pattern series.", group: "language", category: "language", icon: "FlaskConical", hide: true },
  { path: "/language/exams/tms", file: "language/exams/Tms", comp: "ExamTms", label: "TMS mock", title: "TMS — Übungstest (practice)", eyebrow: "Übungstest · TMS", desc: "A timed, auto-scored practice run of TMS reasoning subtests (in German): quantitative/formal problems and number-pattern matching.", group: "language", category: "language", icon: "FlaskConical", hide: true },
  ...
  { path: "/arrival/recognition", file: "arrival/Recognition", comp: "ArrivalRecognition", label: "Professional recognition", title: "Professional recognition (Approbation & regulated professions)", eyebrow: "G8-01 · Arrival", desc: "Medicine, nursing, law, teaching and chamber professions need their qualification recognised before you can legally work — the authority class, the language bar, and the deficit-exam path.", group: "arrival", icon: "BadgeCheck", disclaimer: true },
  { path: "/arrival/support", file: "arrival/Support", comp: "ArrivalSupport", label: "Help, health & community", title: "Help, health & community — who to call", eyebrow: "G8-05 · Arrival", desc: "The non-bureaucratic safety net: emergency numbers, how to see a doctor, after-hours care, university psychological counselling, and buddy/community programmes.", group: "arrival", icon: "LifeBuoy", disclaimer: true },
